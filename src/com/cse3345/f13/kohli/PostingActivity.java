...
public class PostingActivity extends Activity implements OnClickListener
{
	...
	private TextView profilePicture, mHours;
	private byte [] jpegData;
	private Spinner mCatSpin;
	private String mChosenCategory, mHoursData;
	...
	private final static int HOURS_RESULTCODE = 2;
	@Override  
	protected void onActivityResult(int requestCode, int resultCode, Intent intent) {  
		...
		else if (requestCode == HOURS_RESULTCODE)
			mHoursData = intent == null || resultCode != RESULT_OK ? ""  : intent.getStringExtra("Hours");  
		else{
//-----------I wrote this code below this line----------------------------------
	...
	public void onClick(View inButton)
	{
		...
		if (inButton.getId() == openWeb.getId())
			...
			startActivityForResult(new Intent(this, CheckActivity.class), HOURS_RESULTCODE);
...
//			Toast.makeText(getApplicationContext(), payment.toString(), Toast.LENGTH_LONG).show();
						...
						intent.putExtra("Hours", mHoursData);
	...
	public void findViews(){
		...
		mHours = (TextView)findViewById(R.id.availstr);
	}
