...
public class MainActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String [] heads = {"For sale","Lost & Found","Nearby Places", "Q&A", "Tutors", "Jobs"};
				...
				public View getView(int pos, View convertView, ViewGroup parent){
					...
					view.setOnClickListener(new OnClickListener(){
							public void onClick(View v){
								Intent i = new Intent(new Intent(getApplicationContext(), com.allthelucky.common.view.sample.test.class));
								i.putExtra("Title", tv.getText());
								TextView price = (TextView) findViewById(R.id.price);
								price.setText("" + Math.random() * 100);
